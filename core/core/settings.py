...
SECRET_KEY = "django-insecure-ef8%1sgd&b$vp6a!qry@-18vqcku-fk5isytp86m8n--(6eghy"
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=5),  # Access token ömrü
    'REFRESH_TOKEN_LIFETIME': timedelta(days=1),    # Refresh token ömrü
    'ROTATE_REFRESH_TOKENS': True,
    'BLACKLIST_AFTER_ROTATION': True,
}

#logging yapılandırma ayarları
import os
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': os.path.join(BASE_DIR, 'news_logs.log'),
            'formatter': 'verbose',
        },
    },
    'loggers': {
        ...
        'news': {  # Uygulamanıza özel bir logger
            'handlers': ['file'],
            'level': 'DEBUG',
            'propagate': True,
        },
